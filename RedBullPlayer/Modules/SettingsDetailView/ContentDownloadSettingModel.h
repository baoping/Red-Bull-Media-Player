 ...
 */
#ifndef CONTENTDOWNLOADSETTINGMODEL_H
#define CONTENTDOWNLOADSETTINGMODEL_H
...
namespace RedBullPlayer {
    namespace Modules {
        namespace SettingsDetailView {
            class ContentDownloadSettingModel : public ISettingsModel {
                    Q_OBJECT
                public:
                    ContentDownloadSettingModel( QObject *parent, ISettingsBooleanSettingView *view,
...
#endif // CONTENTDOWNLOADSETTINGMODEL_H
