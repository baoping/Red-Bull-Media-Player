 ...
 */
#ifndef PODCASTVIEWSTATISTICURLGENERATOR_H
#define PODCASTVIEWSTATISTICURLGENERATOR_H
...
namespace RedBullPlayer {
    namespace Modules {
        namespace Statistics {
            ...
            class PodCastViewStatisticUrlGenerator : public RedBullPlayer::Modules::Statistics::IUrlGenerator {

                public:
                    PodCastViewStatisticUrlGenerator() : IUrlGenerator() {
                        _playerUuid = QUuid();
                        _apiKey = "";
                    };
...
#endif // PODCASTVIEWSTATISTICURLGENERATOR_H
