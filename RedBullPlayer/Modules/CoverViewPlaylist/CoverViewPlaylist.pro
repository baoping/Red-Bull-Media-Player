...
QT += network \
    ...
    svg \
    sql
TARGET = CoverViewPlaylistModule
TEMPLATE = lib
CONFIG += plugin
INCLUDEPATH += ../../../3rdParty/src/qtanimationframework-2.3/src
DEFINES += COVERVIEWPLAYLIST_LIBRARY
...
unix:DEFINES += QT_EXPERIMENTAL_SOLUTION \
    QT_STATEMACHINE_SOLUTION \
    Q_ANIMATION_EXPORT=
SOURCES += CoverViewPlaylistModule.cpp \
    CoverViewPlaylistUI.cpp
HEADERS += CoverViewPlaylistModule.h \
    CoverViewPlaylistUI.h
...
unix:!macx:copy_animation_framework.commands = cp \
    -vr \
    ../../../3rdParty/Linux/qtanimationframework-2.3/lib/libQtSolutions_AnimationFramework-2.3.so.1 \
    $$DESTDIR
