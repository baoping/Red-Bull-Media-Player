 ...
 */
#include "PlayerPaused.h"

using namespace RedBullPlayer::Modules::MediaLibrary;
using namespace RedBullPlayer::Container;
using namespace RedBullPlayer::Modules::Player;

PlayerPaused::PlayerPaused( PlayerModel* playerModel,
...
bool PlayerPaused::enterState() {
    if( playerModel()->mediaType() == PlayerModel::AUDIO )
        audioAnimationEngine()->pauseAnimation();

    return true;
}

bool PlayerPaused::leaveState() {
    return true;
}
