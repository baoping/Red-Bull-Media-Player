...
namespace RedBullPlayer {
    namespace Modules {
        namespace TopUI {
            class DiskSpacePresenter : public StateIconPresenter {
                    Q_OBJECT
                public:
                    DiskSpacePresenter( RedBullPlayer::Widgets::StatusDisplayButton * view, DiskSpaceModel* model, QObject *parent = 0 );
