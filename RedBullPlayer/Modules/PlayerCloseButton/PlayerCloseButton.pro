...
QT += network \
    ...
    svg \
    sql
TARGET = PlayerCloseButtonModule
TEMPLATE = lib
CONFIG += plugin
SOURCES += PlayerCloseButtonModule.cpp \
    PlayerCloseButtonUI.cpp
HEADERS += PlayerCloseButtonModule.h \
    PlayerCloseButtonUI.h
