...
QT += network \
    ...
    svg \
    sql
TARGET = ListViewPlaylistModule
TEMPLATE = lib
CONFIG += plugin
INCLUDEPATH += ../../../3rdParty/src/qtanimationframework-2.3/src
DEFINES += LISTVIEWPLAYLIST_LIBRARY
...
unix:DEFINES += QT_EXPERIMENTAL_SOLUTION \
    QT_STATEMACHINE_SOLUTION \
    Q_ANIMATION_EXPORT=
SOURCES += ListViewPlaylistModule.cpp \
    ListViewPlaylistUI.cpp
HEADERS += ListViewPlaylistModule.h \
    ListViewPlaylistUI.h
