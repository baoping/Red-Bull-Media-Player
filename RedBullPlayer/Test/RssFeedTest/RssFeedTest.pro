...
HEADERS += ../AutoTest.h \
    ../../ToolLib/RssFeed/RssFeed.h \
    ../../ToolLib/RssFeed/RssFeedItem.h \
    ../../ToolLib/RssFeed/RssFeedImageDescriptor.h \
    rssfeedtest.h
SOURCES += ../main.cpp \
    ../../ToolLib/RssFeed/RssFeed.cpp \
    ../../ToolLib/RssFeed/RssFeedItem.cpp \
    ../../ToolLib/RssFeed/RssFeedImageDescriptor.cpp \
    rssfeedtest.cpp
INCLUDEPATH += ../../ToolLib/RssFeed/ \
    ../../Interfaces/RssFeed/
...
unix:copy_to_destdir.commands = cp -vrf *.xml $$DESTDIR/

POST_TARGETDEPS += copy_to_destdir
QMAKE_EXTRA_TARGETS += copy_to_destdir
OTHER_FILES += testRssFeed.xml
