 ...
 */
#include "PodCastViewStatisticUrlGeneratorTest.h"
...
//void PodCastViewStatisticUrlGeneratorTest::should_create_correct_url() {
//    StatisticEntry* e = new StatisticEntry( UuidCreator::create(), Constants::STATISTIC_EVENT_TYPE_PODCAST_VIEW, "TestData", QDateTime::currentDateTime() );
//    PodCastViewStatisticUrlGenerator g;
//
...
//    urlTemplate = urlTemplate.replace(Constants::STATISTIC_DATA_URL_KEY,QString(e->data().toUtf8().toHex()));
//
...
//    //QVERIFY2( ! u.hasQueryItem( Constants::STATISTIC_PLAYERID_URL_KEY ), "Url must not contain player id item" );
//    //QVERIFY2( u.queryItemValue( Constants::STATISTIC_TYPE_URL_KEY ) == Constants::STATISTIC_EVENT_TYPE_PODCAST_VIEW_URL_VALUE, "Url must contain podcast view statistic as eventType" );
//    //QVERIFY2( u.queryItemValue( Constants::STATISTIC_DATE_URL_KEY ) == date, "Url must contain the event date" );
//    //QVERIFY2( u.queryItemValue( Constants::STATISTIC_DATA_URL_KEY ) == "TestData", "Url must contain the event data" );
//}
