...
Q_OBJECT
public:
    MovementState(SubMarine *submarine, QtState *parent = 0) : QAnimationState(parent)
    {
        movementAnimation = new QtPropertyAnimation(submarine, "pos");
...
private:
    SubMarine *submarine;
    QtPropertyAnimation *movementAnimation;
};
...
{
public:
    ReturnState(SubMarine *submarine, QtState *parent = 0) : QAnimationState(parent)
    {
        returnAnimation = new QtPropertyAnimation(submarine, "yRotation");
...
private:
    SubMarine *submarine;
    QtPropertyAnimation *returnAnimation;
};
