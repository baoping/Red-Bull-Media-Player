...
private:
    void connectByAnimation(QtState *s1, QtAbstractState *s2, 
                            QtAbstractTransition *transition = 0);
    QtState *makeState(QtState *parentState, const QString &animationFileName);

    StickMan *m_stickMan;
    QtStateMachine *m_machine;
    QtAnimationGroup *m_animationGroup;
